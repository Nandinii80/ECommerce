...
const MainBanner = () => {
  return (
    ...
    <div className='flex items-center mt-6 font-medium'>
        ...
        Shop Now
        <img src={assets.white_arrow_icon} alt='arrow' className='md:hidden transition group-focus:translate-x-1'></img>
        </Link>

        <Link to={"/products"} className='group hidden md:flex items-center gap-2 px-9 py-3 cursor-pointer'>
        Explore Deals
        <img src={assets.black_arrow_icon} alt='arrow' className='transition group-hover:translate-x-1'></img>
        </Link>
    </div>
    </div>
    </div>

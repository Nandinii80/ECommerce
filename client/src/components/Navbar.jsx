...
const Navbar = () => {
    ...
    const {user,setUser,SetShowUserLogin,axios,setsearchQuery,searchQuery,getCartCount} =  UseAppContext();
       ...
       <button onClick={()=>SetShowUserLogin(true)} className="cursor-pointer px-8 py-2 bg-primary hover:bg-primary-dull transition text-white rounded-full">
        ...
        :(
            <div className='relative group'>
                ...
                <ul className='hidden group-hover:block absolute top-10 right-0 bg-white shadow border border-gray-200 p-2.5 w-30 rounded-md text-sm z-40'>
